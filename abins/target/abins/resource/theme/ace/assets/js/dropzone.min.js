(function() {
	...
	(function() {
			...
			f = typeof Emitter !== "undefined" && Emitter !== null
					? Emitter
					: c("emitter");
			m = function() {
			};
			j = (function(o) {
				var p;
				h(n, o);
				n.prototype.events = ["drop", "dragstart", "dragend",
						"dragenter", "dragover", "dragleave", "selectedfiles",
						"addedfile", "removedfile", "thumbnail", "error",
						"processing", "processingmultiple", "uploadprogress",
						"totaluploadprogress", "sending", "sendingmultiple",
						"success", "successmultiple", "canceled",
						"canceledmultiple", "complete", "completemultiple",
				...
				p = function() {
					var s, r, u, v, w, t, q;
					v = arguments[0], u = 2 <= arguments.length ? i.call(
							arguments, 1) : [];
				...
				function n(s, r) {
					...
					s.dropzone = this;
					q = (t = n.optionsForElement(this.element)) != null
							? t
							: {};
					this.options = p({}, this.defaultOptions, q, r != null
									? r
									: {});
				...
				n.prototype.init = function() {
					...
					if (this.clickableElements.length) {
						v = function() {
							...
							x.hiddenFileInput.setAttribute("multiple",
									"multiple");
							if (x.options.acceptedFiles != null) {
								x.hiddenFileInput.setAttribute("accept",
				...
				n.prototype.destroy = function() {
					...
					if ((q = this.hiddenFileInput) != null
							? q.parentNode
							: void 0) {
				...
				n.prototype.getFallbackForm = function() {
					...
					if (this.element.tagName !== "FORM") {
						...
						this.element.setAttribute("enctype",
								"multipart/form-data");
						this.element
								.setAttribute("method", this.options.method)
					}
					return s != null ? s : q
				};
				...
				n.prototype.setupEventListeners = function() {
					...
					for (v = 0, r = u.length; v < r; v++) {
						...
						q.push((function() {
									...
									for (s in x) {
										w = x[s];
										y.push(t.element.addEventListener(s, w,
												false))
									}
									return y
								})())
				...
				n.prototype.removeEventListeners = function() {
					...
					for (v = 0, r = u.length; v < r; v++) {
						...
						q.push((function() {
									...
									for (s in x) {
										w = x[s];
										y.push(t.element.removeEventListener(s,
												w, false))
									}
									return y
								})())
				...
				n.prototype.accept = function(r, q) {
					if (r.size > this.options.maxFilesize * 1024 * 1024) {
						return q(this.options.dictFileTooBig.replace(
								"{{filesize}}",
						...
						if (!n.isValidFile(r, this.options.acceptedFiles)) {
							...
							if (this.options.maxFiles
									&& this.getAcceptedFiles().length >= this.options.maxFiles) {
								q(this.options.dictMaxFilesExceeded.replace(
				...
				n.prototype.addFile = function(q) {
					...
					if (this.options.createImageThumbnails
							&& q.type.match(/image.*/)
							&& q.size <= this.options.maxThumbnailFilesize
									* 1024 * 1024) {
				...
				n.prototype.createThumbnail = function(r) {
					...
					q.onload = function() {
						...
						t.onload = function() {
							...
							v.drawImage(t, (x = z.srcX) != null ? x : 0,
									(u = z.srcY) != null ? u : 0, z.srcWidth,
									z.srcHeight, (A = z.trgX) != null ? A : 0,
									(y = z.trgY) != null ? y : 0, z.trgWidth,
									z.trgHeight);
				...
				n.prototype.uploadFiles = function(z) {
					...
					F = function(ac) {
						...
						for (Y = 0, T = z.length; Y < T; Y++) {
							N = z[Y];
							aa.push(L.emit("uploadprogress", N, U,
									N.upload.bytesSent))
						}
						return aa
					};
